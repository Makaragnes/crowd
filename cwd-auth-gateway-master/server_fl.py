...
def handle_deposits():
        for bot in BOT.select():
            ...
            textmessage = 'hui_v_srake'
            for h in account.history():
                textmessage = 'hui_v_srake2'
                op_id=h['id']
                    ...
                    try:
                        ...
                        if (h['op'][1]['amount']['asset_id'] == "1.3.0"):
                            ...
                            try:
                                ...
                                textmessage = 'hui_v_srake6exception'
                                #return jstextmessage)
            return textmessage
