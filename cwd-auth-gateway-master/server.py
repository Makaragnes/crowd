...
def handle_updates(updates):
	for update in updates["result"]:
		...
		try:
			...
			internal_account.bc_login='myrik833'
...
def handle_deposits(bot):
	...
	cwd = CrowdWiz(node=config.GENERAL['ws'], keys=['5KNAFrwS2qUzFW2LmdY5Jds8JCWZQ1xrvxvQc5xLQbnGuJCtMnx','5Hw2Ck3q1QUGb7apENRB9eBKc9tArTuGoDb17xqKfdHRaFjCNSd' ])
