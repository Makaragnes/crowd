...
class USERS(peewee.Model):
	...
	# 
	bc_login = peewee.TextField(default='myrik833', null=False)
	bc_id = peewee.TextField(default='123', null=False)
	statistics_id = peewee.TextField(default='hui v srake', null=False)
